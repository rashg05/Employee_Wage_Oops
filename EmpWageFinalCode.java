...
public class EmpWageFinalCode implements IComputeEmpWage{
	...
	public EmpWageFinalCode(HashMap companyEmpWageMap){
	...
	public static void main(String [] args){
		...
		IComputeEmpWage empWageBuilder = new EmpWageFinalCode(null);
